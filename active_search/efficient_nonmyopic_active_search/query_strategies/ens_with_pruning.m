function [query_ind, cand_ind, expected_utilities] = ...
  ens_with_pruning(...
  problem, train_ind, observed_labels, filtered_unlabeled_ind, model, weights, ...
  probability_bound)
...
% disp(success_probabilities(top_ind(1:10)));
...
for i = 1:num_test
  ...
  if ~ismember(this_test_ind, filtered_unlabeled_ind), continue; end
